...
import { ToneControlPanel } from './components/ToneControlPanel';
...
const handleToneChange = (tone: Tone, arousal: number) => {
  setSignal({ tone, arousal });
};
  ...
  return (
    ...
    <SceneNarrative tone={signal.tone} />
    <ToneTrail tone={signal.tone} />
    <ToneControlPanel onToneChange={handleToneChange} />
    </div>
  );
}
